...
export default function CheckListItem({id, name, value, checked, onChange}: Props) {
    return (
        <label className='flex gap-3 items-center p-3 bg-light-medium-grey dark:bg-very-dark-grey hover:bg-primary-button-hover-color cursor-pointer rounded-md check-list-item select-none'>
            ...
            <div className='text-paragraph-xs font-bold text-heading-color dark:text-heading-on-dark-color break-all check-list-item-value'>
                {value}
            </div>
        </label>
    )
